...
import { CollectionVisibility, EditCollectionDto } from '@/types';
...
export function EditCollectionForm(props: { collectionId: string }) {
  ...
  const handleEditCollection = async ({ name, description }) => {
    ...
    try {
      ...
      await api.put(`/collections/${props.collectionId}`, dto);
